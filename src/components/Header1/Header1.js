...
function Header() {
    ...
    const [privateKey0, setprivateKey0] = useState('ba8bacab1e7b6ce164bad3dea393bcb9a0a026081273460eaee60fdbbc28d44a');
    const [privateKey1, setprivateKey1] = useState('89c4098103efc3e5ac312a2eb03781409b30b2e2366469be93094bb39bfedd4d');
    // const textAreaRef = useRef(null);
    const [textAreaRef, settextAreaRef] = useState('');
    const [account, setaccount] = useState('0x2313C8D0D6757E1bd44bDabe7225be31EC20D85D');
    ...
    return (
        <>
            <Particles
                style={{ position: "absolute", position: 'absolute', left: '0px', zIndex: '-3' }}
                height='140%'
                width="100%"
                params={{
                    particles: {
            ...
            <div className=' container w-100 headerDiv '>
                <div className="">
                    <div className="d-flex mt-4 mb-5 flex-column">
                        {/* <span>{privateKey0}</span> */}
                        {/* <span>{privateKey1}</span> */}
                        ...
                        <div className="d-flex flex-sm-wrap flex-md-nowrap flex-lg-nowrap flex-wrap align-items-center btnInpo_head_div">
                            <button className="btn btn-warning text-black fw-bolder">My Referral Link</button>
                            <div className="border border-warning d-flex justify-content-center align-items-center">
                                <input id="textAreaRef"
                                    value={`${window.location.protocol}//${window.location.host
                                        }/login?ref=${account}`}
                                    className=" border-0 bg-transparent inpoClass" placeholder="Enter ..." type="text" />
                                <i onClick={copyToClipboard} class="far fa-copy" style={{ cursor: 'pointer' }}></i>
                            </div>
                        </div>
                        ...
                        <div className="mt-4 d-flex justify-content-between text-start flex-wrap">
                            <div className="d-flex footersmallcard flex-column ">
                                <div className="d-flex justify-content-sm-between fontWeightSmall">
                                    <p>ADA/BUSD </p>
                                    <p className="text-danger" style={{ marginLeft: '10px' }}>-0.37%</p>
                                </div>
