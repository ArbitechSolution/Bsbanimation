...
function Dashboard() {
    ...
    const gettimer = () => {
        try {
            ...
            console.log("timer", block);
            console.log("timer", block - Currenttimestamp);
            // console.log("timer", remHours);
                        ...
                        <div className="row">
                            ...
                            <div className="col-sm-9 dashreferral" >
                                <input
                                    ...
                                    // }/login?ref=${tttmbalance ? userAccount : ""}`}
                                    style={{
                                        fontWeight: "600",
                                    }}
                                />
                    ...
                    <div className="col-md-8">
                        <div className="row">
                            <div className="col-md-4 dashdetail">
                                <div className="row">
                                    <div className="col-sm-2 dashtext">
                                        BSB
                                    </div>
                                    <div className="col-sm-2 dashtext" style={{ color: "greenyellow" }}>
                                        +45%
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col dashnumebr">
                                        0.34
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="row dashrates">
                            <div className="col-md">
                                <div className="row">
                                    ...
                                    <span className="col-sm-3" style={{ color: "red" }}>-0.37%</span>
                                </div>
                                <div className="row">
                                    <p className="col">
                                        1.3427
